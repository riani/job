<div id="contentwrap">
    <div id="page-title">
        <h1>Create <span> Company</span></h1>
    ...
    <div id="page-content">
        <div class="columns">
            <div class="column">
                <div class="content">
                    <form method="post" action="<?php echo site_url('company/simpan');?>">
                        <div class="blocksection">
                            ...
                            <div class="blockcontent">
                                ...
                                <dl class="form-text">
                                    <dt>
                                        <label for="text_14">No Telepon:</label>
                                    </dt>
                                    <dd>
                                        <input type="text" id="text_14" name="no_telp" value=""/>
                                        <?php echo form_error('no_telp', ' <div class="boxinfo error">', '</div>'); ?>
                                ...
                                <dl class="form-text">
                                    <dt>
                                        <label for="text_14">No Fax:</label>
                                    </dt>
                                    <dd>
                                        <input type="text" id="text_14" name="no_fax" value=""/>
                                        <?php echo form_error('no_fax', ' <div class="boxinfo error">', '</div>'); ?>
                                ...
                                <dl class="form-text">
                                    <dt>
                                        <label for="text_15">Email:</label>
                                    </dt>
                                    <dd>
                                        <input type="text" id="text_15" name="email_cp" value=""/>
                                        <?php echo form_error('email_cp', ' <div class="boxinfo error">', '</div>'); ?>

                                        <p class="description">Email untuk kontak perusahaan.</p>
                                    </dd>
                                </dl>

                                <dl class="form-text">
                                    <dt>
                                        <label for="text_16">Email event:</label>
                                    </dt>
                                    <dd>
                                        <input type="text" id="text_16" name="email_event" value=""/>
                                        <?php echo form_error('email_event', ' <div class="boxinfo error">', '</div>'); ?>

                                        <p class="description">Email untuk menerima email dari pelamar.</p>
                                    </dd>
                                </dl>
                            </div>
