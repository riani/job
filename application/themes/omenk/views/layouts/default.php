...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() .'static/'?>css/smoothness/jquery-ui-1.8.18.custom.css" type="text/css"/>
...
<!--    <script type="text/javascript" src="--><?php //echo base_url() . 'static/'?><!--js/jquery-1.3.2.min.js"></script>-->
    <script type="text/javascript" src="<?php echo base_url() . 'static/'?>js/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url() . 'static/'?>js/jquery-ui-1.8.18.custom.min.js"></script>
...
<div id="footerout">
    <div class="container">
        <div id="footer">
            ...
            <div id="copyright">
                &copy; omenkzz@gmail.com    <br />
<!--                <a href="http://twitter/omenkzz">copyright &copy; @omenkzz</a>-->
            </div>
